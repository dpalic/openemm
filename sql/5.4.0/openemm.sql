...
INSERT INTO `admin_tbl` (`admin_id`, `username`, `company_id`, `fullname`, `timestamp`, `admin_country`, `admin_lang`, `admin_lang_variant`, `admin_timezone`, `layout_id`, `creation_date`, `pwd_change`, `admin_group_id`, `pwd_hash`) VALUES (1,'admin',1,'Administrator','2006-06-23 12:04:35','EN','en','','Europe/Berlin',0,'2008-02-12 10:55:53','0000-00-00 00:00:00',4,'›×–™oÍô\nÓØ`%À?,');
UNLOCK TABLES;
