...
INSERT INTO `admin_group_permission_tbl` (`admin_group_id`, `security_token`) VALUES (4,'action.getcustomer'),(4,'action.op.ActivateDoubleOptIn'),(4,'action.op.ExecuteScript'),(4,'action.op.GetArchiveList'),(4,'action.op.GetArchiveMailing'),(4,'action.op.GetCustomer'),(4,'action.op.SendMailing'),(4,'action.op.ServiceMail'),(4,'action.op.SubscribeCustomer'),(4,'action.op.UnsubscribeCustomer'),(4,'action.op.UpdateCustomer'),(4,'actions.change'),(4,'actions.delete'),(4,'actions.set_usage'),(4,'actions.show'),(4,'admin.change'),(4,'admin.delete'),(4,'admin.new'),(4,'admin.show'),(4,'adminlog.show'),(4,'blacklist'),(4,'campaign.change'),(4,'campaign.delete'),(4,'campaign.new'),(4,'campaign.show'),(4,'campaign.stat'),(4,'charset.use.gb2312'),(4,'charset.use.iso_8859_1'),(4,'charset.use.iso_8859_15'),(4,'charset.use.utf_8'),(4,'cms.central_content_management'),(4,'cms.mailing_content_management'),(4,'forms.change'),(4,'forms.delete'),(4,'forms.view'),(4,'import.mode.add'),(4,'import.mode.add_update'),(4,'import.mode.bounce'),(4,'import.mode.blacklist'),(4,'import.mode.doublechecking'),(4,'import.mode.null_values'),(4,'import.mode.only_update'),(4,'import.mode.remove_status'),(4,'import.mode.unsubscribe'),(4,'mailing.archived'),(4,'mailing.attachments.show'),(4,'mailing.change'),(4,'mailing.components.change'),(4,'mailing.components.show'),(4,'mailing.content.show'),(4,'mailing.copy'),(4,'mailing.default_action'),(4,'mailing.delete'),(4,'mailing.graphics_upload'),(4,'mailing.new'),(4,'mailing.send.admin'),(4,'mailing.send.admin.options'),(4,'mailing.send.show'),(4,'mailing.send.test'),(4,'mailing.send.world'),(4,'mailing.show'),(4,'mailing.show.charsets'),(4,'mailing.show.types'),(4,'mailinglist.change'),(4,'mailinglist.delete'),(4,'mailinglist.new'),(4,'mailinglist.show'),(4,'profileField.show'),(4,'recipient.change'),(4,'recipient.delete'),(4,'recipient.new'),(4,'recipient.show'),(4,'recipient.view'),(4,'settings.show'),(4,'stats.clean'),(4,'stats.domains'),(4,'stats.ip'),(4,'stats.mailing'),(4,'stats.rdir'),(4,'targets.createml'),(4,'targets.show'),(4,'template.change'),(4,'template.components.show'),(4,'template.delete'),(4,'template.new'),(4,'template.show'),(4,'update.show'),(4,'use_charset_iso_8859_1'),(4,'userlog.show'),(4,'wizard.export'),(4,'wizard.import');
...
INSERT INTO `admin_tbl` (`admin_id`, `username`, `company_id`, `fullname`, `timestamp`, `admin_country`, `admin_lang`, `admin_lang_variant`, `admin_timezone`, `layout_id`, `creation_date`, `pwd_change`, `admin_group_id`, `pwd_hash`, `preferred_list_size`, `default_import_profile_id`) VALUES (1,'admin',1,'Administrator','2009-10-12 11:11:54','EN','en','','Europe/Berlin',0,'2009-10-12 11:11:54','2009-10-12 11:11:54',4,0x9BD796996FCDF40AD3D86025C03F2C9E,0,0);
...
INSERT INTO `click_stat_colors_tbl` (`id`, `company_id`, `range_start`, `range_end`, `color`) VALUES (1,1,0,5,'F4F9FF'),(2,1,5,10,'D5E6FF'),(3,1,10,15,'E1F7E1'),(4,1,15,20,'FEFECC'),(5,1,20,25,'FFE4BA'),(6,1,25,100,'FFCBC3');
...
INSERT INTO `customer_1_binding_tbl` (`customer_id`, `mailinglist_id`, `user_type`, `user_status`, `user_remark`, `change_date`, `exit_mailing_id`, `creation_date`, `mediatype`) VALUES (1,1,'A',1,'','2009-10-12 11:11:54',0,'2009-10-12 11:11:54',0),(2,1,'T',1,'','2009-10-12 11:11:54',0,'2009-10-12 11:11:54',0);
...
INSERT INTO `customer_1_tbl` (`customer_id`, `email`, `gender`, `mailtype`, `firstname`, `lastname`, `creation_date`, `change_date`, `title`, `datasource_id`) VALUES (1,'first.last@domain.org',0,1,'First','Last','2009-10-12 11:11:54','2009-10-12 11:11:54',NULL,0),(2,'no.name@yourdomain.com',0,1,'No','Name','2009-10-12 11:11:54','2009-10-12 11:11:54',NULL,0);
...
INSERT INTO `mailing_tbl` (`mailing_id`, `company_id`, `campaign_id`, `shortname`, `description`, `mailing_type`, `creation_date`, `mailtemplate_id`, `is_template`, `deleted`, `target_expression`, `change_date`, `mailinglist_id`, `needs_target`, `archived`, `cms_has_classic_content`) VALUES (1,1,0,'de_template','created by eMM-Xpress',0,'2008-02-12 10:30:14',0,1,0,'','2011-01-28 08:20:02',1,0,0,1),(2,1,0,'en_template','created by eMM-Xpress',0,'2008-02-12 10:47:21',0,1,0,'','2011-01-28 08:20:02',1,0,0,1),(3,1,0,'de_doi_mail','double-opt-in mail, subscribe link',1,'2008-02-12 10:54:06',0,0,0,'','2011-01-28 08:20:02',1,0,0,0),(4,1,0,'en_doi_mail','double-opt-in mail, subscribe link',1,'2008-02-12 10:57:13',0,0,0,'','2011-01-28 08:20:02',1,0,0,0);
...
INSERT INTO `rdir_action_tbl` (`action_id`, `shortname`, `description`, `action_type`, `company_id`, `operations`) VALUES (1,'doi_user_confirm','step 1/2: confirm user',1,1,0xACED0005737200136A6176612E7574696C2E41727261794C6973747881D21D99C7619D03000149000473697A6578700000000177040000000A7372002B6F72672E61676E697461732E616374696F6E732E6F70732E4163746976617465446F75626C654F7074496E6C8B81A57A32855A020000787078),(2,'doi_user_register (de)','step 2/2: save user data, send doi-mail',1,1,),(3,'doi_user_register (en)','step 2/2: save user data, send doi-mail',1,1,),(4,'user_get_data','load data from database',1,1,0xACED0005737200136A6176612E7574696C2E41727261794C6973747881D21D99C7619D03000149000473697A6578700000000177040000000A737200236F72672E61676E697461732E616374696F6E732E6F70732E476574437573746F6D65729A70BAE4FE18BCD30200015A000A6C6F6164416C7761797378700078),(5,'user_subscribe','subscribe user',1,1,),(6,'user_unsubscribe','unsubscribe user',1,1,0xACED0005737200136A6176612E7574696C2E41727261794C6973747881D21D99C7619D03000149000473697A6578700000000177040000000A7372002B6F72672E61676E697461732E616374696F6E732E6F70732E556E737562736372696265437573746F6D657216BBF6CEE04FB108020000787078);
...
INSERT INTO `tag_tbl` (`tag_id`, `tagname`, `selectvalue`, `type`, `company_id`, `description`, `change_date`) VALUES (1,'agnCUSTOMERID','cust.customer_id','SIMPLE',0,NULL,'2006-07-10 07:58:25'),(2,'agnMAILTYPE','cust.mailtype','SIMPLE',0,NULL,'2006-07-10 07:58:25'),(3,'agnIMAGE','\'[rdir-domain]/image?ci=[company-id]&mi=[mailing-id]&name={name}\'','COMPLEX',0,NULL,'2006-07-10 07:58:25'),(4,'agnDB','cust.{column}','COMPLEX',0,'Display one Column','2006-07-10 07:58:25'),(5,'agnTITLE','\'builtin\'','SIMPLE',0,NULL,'2006-07-10 07:58:25'),(6,'agnFIRSTNAME','cust.firstname','SIMPLE',0,NULL,'2006-07-10 07:58:25'),(7,'agnLASTNAME','cust.lastname','SIMPLE',0,NULL,'2006-07-10 07:58:25'),(8,'agnEMAIL','cust.email','SIMPLE',0,NULL,'2006-07-10 07:58:25'),(9,'agnDATE','date_format(current_timestamp, \'%d.%m.%Y\')','SIMPLE',0,NULL,'2006-07-10 07:58:25'),(10,'agnIMGLINK','\'<a href=\"[rdir-domain]/r.html?uid=[agnUID]\"><img src=\"[rdir-domain]/image?ci=[company-id]&mi=[mailing-id]&name={name}\" border=\"0\"></a>\'','COMPLEX',0,NULL,'2008-06-08 22:00:00');
