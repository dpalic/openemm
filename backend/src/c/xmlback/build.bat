...
cl /DWIN32 "/DVERSION=\"OpenEMM 2015\"" /Dinline= /I. /I..\lib /I..\lib\win "/I%chome%\include" /c append.c block.c blockmail.c blockspec.c codec.c convert.c count.c counter.c create.c data.c dcache.c dyn.c eval.c field.c fix.c generate.c links.c mailtype.c media.c misc.c modify.c none.c parse.c postfix.c receiver.c replace.c sqllike.c tag.c tagpos.c url.c xmlback.c preview.c rblock.c
