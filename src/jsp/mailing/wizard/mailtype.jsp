...
<html:form action="/mwMailtype">
    ...
    <b><font color=#73A2D0><bean:message key="MWizardStep_5_of_11"/></font></b>
    ...
    <BR>
    &nbsp;&nbsp;<html:radio property="emailFormat" style="vertical-align:text-bottom;" value="1"/>&nbsp;<bean:message key="Text_HTML"/>
    <BR>
    &nbsp;&nbsp;<html:radio property="emailFormat" style="vertical-align:text-bottom;" value="2"/>&nbsp;<bean:message key="Text_HTML_OfflineHTML"/>
    <BR>
    <BR> 
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            ...
            <td align="right">
                ...
                &nbsp;
                <html:image src="button?msg=Proceed"  border="0" onclick="<%= "document.mailingWizardForm.action.value='" + MailingWizardAction.ACTION_MAILTYPE + "'" %>"/>
                &nbsp;
            </td>
        </tr>
    </table>         
