<%-- checked --%>
<%@ page language="java" import="org.agnitas.beans.Mailing, org.agnitas.util.AgnUtils, org.agnitas.web.MailingSendAction, java.text.DateFormat, java.text.DecimalFormat, java.text.NumberFormat" contentType="text/html; charset=utf-8" %>
...
<div id="filterbox_container" style="margin-left:28px; ">
    <div class="filterbox_form_container">
        ...
        <div id="suchbox_content" class="filterbox_form_container">
            <label style="margin-left:10px;">${mailingSendForm.shortname}&nbsp;&nbsp;<%if (aForm != null && aForm.getDescription() != null && !aForm.getDescription().isEmpty()) {%>|&nbsp;&nbsp;${mailingSendForm.description}<% } %></label>
        </div>
            ...
            <logic:equal name="mailingSendForm" property="worldMailingSend" value="true">
                ...
                <logic:equal name="mailingSendForm" property="mailingtype" value="<%= Integer.toString(Mailing.TYPE_DATEBASED) %>">
                    ...
                    <logic:equal name="mailingSendForm" property="worldMailingSend" value="true">
                        ...
                        <br><bean:message key="mailing.SendingTimeDaily"/>:&nbsp;<%= timeFormat.format(aDelstat.getScheduledSendTime()) %>
                    </logic:equal>
                </logic:equal>
            </logic:equal>
...
<div class="mailing_name_box_container">
    ...
    <div class="mailing_name_box_content">
            ...
            <div class="target_button_container send_page_button_container">
                <div class="maildetail_button send_page_button">
                    <html:link page='<%= new String(\"/mailingsend.do?action=\" + MailingSendAction.ACTION_SEND_ADMIN + \"&mailingID=\" + tmpMailingID) %>'>
                  ...
                  <c:otherwise>
	                    ...
	                    <div class="send_page_button_text"><span class="warning"></div><bean:message key="MailingTestAdmin.deleted_target_groups"/></span>
	                </div>
                  </c:otherwise>
                </c:choose>
            ...
            <div class="target_button_container send_page_button_container">
                <div class="maildetail_button send_page_button">
                    <html:link page='<%= new String(\"/mailingsend.do?action=\" + MailingSendAction.ACTION_SEND_TEST + \"&mailingID=\" + tmpMailingID) %>'>
                        <span><bean:message key="button.Send"/></span>
                    </html:link>
                </div>
            </div>
                	...
                	<c:otherwise>
		               <div class="send_page_button_text"><span class="warning"><bean:message key="MailingTestDistrib.deleted_target_groups"/></span>
                           </div>
            ...
            <logic:equal name="mailingSendForm" property="isTemplate" value="false">
                ...
                <div class="target_button_container send_page_button_container">
                    <div class="maildetail_button send_page_button">
                        <html:link page='<%= new String("/mailingsend.do?action=" + MailingSendAction.ACTION_DEACTIVATE_MAILING + "&mailingID=" + tmpMailingID) %>'>
                ...
                <div class="target_button_container send_page_button_container">
                    <div class="maildetail_button send_page_button">
                        <html:link page='<%= new String("/mailingsend.do?action=" + MailingSendAction.ACTION_ACTIVATE_CAMPAIGN + "&to=3&mailingID=" + tmpMailingID) %>'>
                    ...
                    <div class="target_button_container send_page_button_container">
                        <div class="maildetail_button send_page_button">
                            <a href="#" onclick="document.getElementsByName('mailingSendForm')[0].submit();">
                                ...
                                <div class="send_page_button_text datebased_mailing_time_text"><bean:message key="mailing.SendingTimeDaily"/>:&nbsp;</div>
                ...
                <agn:ShowByPermission token="mailing.send.world">
                    ...
                    <div class="target_button_container send_page_button_container">
                        <div class="maildetail_button send_page_button">
                            <html:link page='<%= new String("/mailingsend.do?action=" + MailingSendAction.ACTION_VIEW_SEND2 + "&mailingID=" + tmpMailingID) %>'>
                                <span><bean:message key="button.Send"/></span>
                            </html:link>
                        </div>
                    </div>
...
<logic:equal name="mailingSendForm" property="mailingtype" value="<%= Integer.toString(Mailing.TYPE_NORMAL) %>">
    <iframe name="delstatbox" src="<html:rewrite page='<%= new String(\"/mailingsend.do?action=\" + MailingSendAction.ACTION_VIEW_DELSTATBOX + \"&mailingID=\" + tmpMailingID) %>'/>" ALLOWTRANSPARENCY="true" width="950" height="300" bgcolor="#73A2D0" scrolling="no" frameborder="0">
