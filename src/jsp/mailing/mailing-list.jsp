        ...
        <div class="filterbox_form_container">
            ...
            <div id="filterbox_content">
                ...
                <div class="filterbox_form_button"><a href="#"
                                                      onclick="document.mailingBaseForm.submit(); return false;"><span><bean:message
...
<display:table class="list_table" id="mailing" name="mailinglist" pagesize="${mailingBaseForm.numberofRows}"
    ...
    <logic:equal name="mailingBaseForm" property="isTemplate" value="false">
        ...
        <display:column headerClass="head_mailing" class="mailing" titleKey="Mailing" sortable="true"
                        url="/mailingbase.do?action=${ACTION_VIEW}" property="shortname" paramId="mailingID"
                        paramProperty="id"/>
        <display:column headerClass="head_description_wide" class="description" titleKey="default.description"
                        property="description" url="/mailingbase.do?action=${ACTION_VIEW}"
                        paramId="mailingID" paramProperty="id" sortable="true"/>
        <display:column headerClass="head_mailinglist" class="mailinglist" titleKey="Mailinglist"
    ...
    <logic:equal name="mailingBaseForm" property="isTemplate" value="true">
        <display:column headerClass="template_head_name header" class="mailing" titleKey="Template" sortable="true"
                        url="/mailingbase.do?action=${ACTION_VIEW}" property="shortname" paramId="mailingID"
                        paramProperty="id"/>
        <display:column headerClass="template_head_desc header" class="description" titleKey="default.description"
                        property="description" url="/mailingbase.do?action=${ACTION_VIEW}"
                        paramId="mailingID" paramProperty="id" sortable="true"/>
