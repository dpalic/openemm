...
<html:errors/>
	<html:form action="/update">
    	...
    	<p>
            <html:link page="<%= new String("/update.do?action=" + UpdateAction.ACTION_LIST) %>"><html:img src="button?msg=Yes" border="0"/></html:link>
            <html:link page="<%= new String("/update.do?action=" + UpdateAction.ACTION_NEW) %>"><html:img src="button?msg=No" border="0"/></html:link>
        </p>
	</html:form>
