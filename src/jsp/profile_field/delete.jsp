...
<html:errors/>
    <html:form action="/profiledb">
        ...
        <br>
        <b><bean:message key="DeleteProfileFieldQuestion"/></b><br>
          <p>
                
                <html:image src="button?msg=Delete" property="kill" value="kill"/>
                <html:link page="<%= new String("/profiledb.do?action=" + ProfileFieldAction.ACTION_VIEW + "&fieldname=" + ((ProfileFieldForm)request.getAttribute("profileFieldForm")).getFieldname()) %>"><html:img src="button?msg=Cancel" border="0"/></html:link>
          </p>
