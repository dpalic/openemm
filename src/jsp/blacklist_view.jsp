...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <form action="<html:rewrite page="/blacklist_view.jsp"/>" method="post">
    <tr>
    ...
    <tr>
        ...
        <td><center>
            <agn:ShowByPermission token="recipient.delete">
                <html:link page="<%= new String("/blacklist_view.jsp?delete=" + URLEncoder.encode((String)pageContext.getAttribute("_agntbl1_email"))) %>"><img src="<bean:write name="emm.layout" property="baseUrl" scope="session"/>delete.gif" alt="L&ouml;schen" border="0"></html:link>&nbsp;
    ...
    <tr>
        <td colspan="2"><center>
            <agn:ShowTableOffset id="agntbl1" maxPages="20">
                <html:link page="<%= new String("/blacklist_view.jsp?listID=" + pageContext.getRequest().getAttribute("mailingListID") + "&startWith=" + startWith) %>">
                    <% if(activePage!=null) { %>
