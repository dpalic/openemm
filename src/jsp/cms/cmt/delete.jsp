...
<span class="head1">${contentModuleTypeForm.name}</span><br/><br/>
<span class="head3"><bean:message key="DeleteCMTQuestion" bundle="cmsbundle"/></span><br>
...
<p>
    <html:form action="/cms_cmt.do">
        ...
        <html:link
                page="/cms_cmt.do?action=${cancelAction}&cmtId=${contentModuleTypeForm.cmtId}"><html:img
