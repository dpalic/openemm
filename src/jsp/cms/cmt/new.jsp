...
<% pageContext.setAttribute("agnHighlightKey", "NewContentModuleType"); %>

<%@include file="/header.jsp" %>
<%@include file="/messages.jsp" %>

<html:form action="/cms_cmt" focus="cmtId">
    <html:hidden property="action"/>
    <table border="0" cellspacing="0" cellpadding="4">
        <tr>
            <td><bean:message key="SelectBaseCMT" bundle="cmsbundle"/>:</td>
            <td>
