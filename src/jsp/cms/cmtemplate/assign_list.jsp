 ...
 ********************************************************************************/
 --%>
<%@ page language="java" contentType="text/html; charset=utf-8" import="org.agnitas.cms.web.CMTemplateAction, org.agnitas.cms.web.forms.CMTemplateForm" %>
...
<c:set var="ACTION_ASSIGN_LIST" value="<%= CMTemplateAction.ACTION_ASSIGN_LIST %>" scope="page" />
