...
<% pageContext.setAttribute("agnSubtitleKey", new String("ContentManagement")); %>
...
<% int i=1; %>
	...
	<table border="0" cellspacing="10" cellpadding="0">
		<tr>
			<agn:ShowNavigation navigation="ContentManagementSub" highlightKey="">
				<agn:ShowByPermission token="<%= _navigation_token %>">
					<td> <table width="300" cellspacing="0" cellpadding="0">
						<tr>
							<td width ="40"><html:link page="<%= _navigation_href %>"><img border="0" width="40" height="38" src="<bean:write name="emm.layout" property="baseUrl" scope="session"/>splash_cms_<%= _navigation_navMsg.toLowerCase().replace('.', '_') %>.gif" alt="<bean:message key="<%= _navigation_navMsg %>"/>"></html:link></td>
						...
						<tr>
							<td colspan=3 class="boxmiddle" height="80" width="300"><img src="images/emm/one_pixel.gif" width=1 height=60 align="left"><html:link page="<%= _navigation_href %>"><bean:message key="<%= new String("splash.cms."+_navigation_navMsg) %>"/></html:link></td>
						</tr>
						<tr>
