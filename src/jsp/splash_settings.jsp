			...
			<agn:ShowNavigation navigation="SettingsSub" highlightKey="">
				<agn:ShowByPermission token="<%= _navigation_token %>">
					<td> <table width="300" cellspacing="0" cellpadding="0">
						<tr>
							<td width ="40"><html:link page="<%= _navigation_href %>"><img border="0" width="40" height="38" src="${emmLayoutBase.imagesURL}/splash_settings_<%= _navigation_navMsg.toLowerCase().replace('.', '_') %>.gif" alt="<bean:message key="<%= _navigation_navMsg %>"/>"></html:link></td>
