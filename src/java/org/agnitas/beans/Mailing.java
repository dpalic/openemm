...
public interface Mailing extends java.io.Serializable {
    ...
    /**
     * Getter for property allowedTargets.
     *
     * @return Value of property allowedTargets.
     */
    //Hashtable getAllowedTargets();
    
    //Hashtable getAllowedTargetsFromDB(Connection dbConn);
    ...
    // boolean loadSendStatus(Connection dbConn);
    ...
    /**
     * Setter for property allowedTargets.
     *
     * @param allowedTargets New value of property allowedTargets.
     */
    //void setAllowedTargets(Hashtable allowedTargets);
